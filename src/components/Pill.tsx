...
export function Pill({ tone = 'neutral', children }: { tone?: Tone; children: string }) {
  return (
    <span className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-2.5 py-1 font-mono text-xs uppercase tracking-widest text-text-muted">
