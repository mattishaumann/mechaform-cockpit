...
export type CaseKey = 'contract_guard' | 'tier_guard' | 'terms_floor' | 'preferred_steering' | 'index_guard' | 'price_benchmark'
...
export interface AgentConfig {
  ...
  chart: 'contract_table' | 'tier_columns' | 'bridge' | 'comparison_cards' | 'index_basket' | 'benchmark_cards'   // the page's one chart
}
...
const raw = (import.meta.env.VITE_ENABLED_AGENTS as string | undefined) ?? 'contract_guard,tier_guard,terms_floor,preferred_steering'
