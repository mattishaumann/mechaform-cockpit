...
export const AGENTS: Record<CaseKey, AgentConfig> = {
  ...
  tier_guard: { key: 'tier_guard', module: 'Spend & Cost Intelligence', layers: [{ key: 'Tier Guard', label: 'Per order' }, { key: 'Tier Guard (annual volume)', label: 'Annual volume at top tier' }] },
